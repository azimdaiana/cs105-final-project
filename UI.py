...
print('You are currently trapped in a castle and must find your way out. To move, you may choose a direction (north, south, west, or east)\n'
      'and then the number of units you want to move.\n'
